	...
	<section id="wrap">
		...
		<table id="registTable">
			...
			<tr>
				...
				<td class="td_right"><input type="text" name="passwd" size="25"></td>
			</tr>
			<tr>
			...
			<tr>	
				...
				<td class="td_right"><input type="text" name="birth" size="3">년
				<input type="text" name="birth" size="2">월
				<input type="text" name="birth" size="2">일
				<input type = "radio" name="solarCalendar" value="s" checked="checked"/>양력
				<input type = "radio" name="solarCalendar" value="l"/>음력
				</td>
			</tr>
				<tr>
